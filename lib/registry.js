...
Registry.prototype._watch = function(path) {
  ...
  client.watch(path, { recursive: true }, function(err, action, key, value) {
    console.log('SD WATCH!!!');
    console.log(err);
    console.log(action);
    console.log(key);
    console.log(value);
    ...
    // TODO: Update cache based on action and key
